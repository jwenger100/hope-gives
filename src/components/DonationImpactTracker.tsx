        ...
        <Container>
          <Box>
            <Grid p="xl">
              ...
              >
                <Zoom>
                  <Paper className={classes.item}>
                    ...
                    <Text ta="center">
                      Track your giving and witness the impact of every
                      donation.
                    </Text>
                  </Paper>
                </Zoom>
              ...
              >
                <Zoom delay={200}>
                  <Paper className={classes.item}>
                    ...
                    <Text ta="center">
                      Follow people's journeys, hear their testimonies, and
              ...
              {/* Additional delay for next item */}
              <Grid.Col
                span={{ base: 12, md: 4 }}
                display={{ base: "block", md: "flex" }}
              >
                <Zoom delay={400}>
                  <Paper className={classes.item}>
                    ...
                    <Text ta="center">
                      It's about fostering an audacious hope that believes in
                      the power of collective effort and the boundless potential
                      of faith in action.
                    </Text>
                  </Paper>
                </Zoom>
